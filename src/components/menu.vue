  ...
  <b-container fluid>
                ...
                <ul class="nav nav-sm flex-column">
                  ...
                  <li class="nav-item">
                    <router-link to="/ui/links" class="nav-link" data-key="t-links">{{ $t("t-links") }}
                      <b-badge variant="success" class="badge-pill" data-key="t-new">{{$t("t-new")}}</b-badge>
                    </router-link>
                  </li>
                  <li class="nav-item">
              ...
              <li class="nav-item">
                ...
                <div class="collapse menu-dropdown" id="sidebarApexcharts">
                  <ul class="nav nav-sm flex-column">
                    ...
                    <li class="nav-item">
                      <router-link to="/charts/apex-range-area" class="nav-link" data-key="t-range-area">{{ $t("t-range-area") }}
                        <b-badge variant="success" class="badge-pill" data-key="t-new">{{$t("t-new")}}</b-badge>
                      </router-link>
                    </li>
                    <li class="nav-item">
    ...
    <template v-else>
      <ul class="navbar-nav h-100" id="navbar-nav">
        ...
        <li class="nav-item">
          <b-link class="nav-link menu-link" href="/" >
            <i class="ri-dashboard-2-line"></i>
            <span data-key="t-dashboards"> {{ $t("t-dashboards") }}</span>
          </b-link>
        </li>
        <!-- end Dashboard Menu -->
          ...
          <li class="nav-item">
              <b-link class="nav-link menu-link" href="#collectivite" data-bs-toggle="collapse" role="button"
                      aria-expanded="false" aria-controls="collectivite">
                  <i class="ri-apps-2-line"></i>
                  <span data-key="t-apps"> {{ $t("t-collectivite") }}</span>
              </b-link>
              <div class="collapse menu-dropdown" id="collectivite">
                  <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                          <router-link :to="{name: 'listeEquipements'}" class="nav-link" data-key="t-calendar">
                              {{ $t("t-equipements") }}
                          </router-link>
                      </li>
                      <li class="nav-item">
                          <router-link :to="{name: 'listeTransactions'}" class="nav-link" data-key="t-calendar">
                              {{ $t("t-transactions") }}
                          </router-link>
                      </li>
                      <li class="nav-item">
                      ...
                      <li class="nav-item">
                          <b-link class="nav-link menu-link" href="#configurations" data-bs-toggle="collapse" role="button"
                                  aria-expanded="false" aria-controls="configurations">
                              <span data-key="t-apps"> {{ $t("t-configurations") }}</span>
                          </b-link>
                          <div class="collapse menu-dropdown" id="configurations">
                              <li class="nav-item">
                                  <router-link :to="{name: 'listeSousEntites'}" class="nav-link" data-key="t-calendar">
                                      {{ $t("t-sous-entites") }}
                                  </router-link>
                              </li>
                              <li class="nav-item">
