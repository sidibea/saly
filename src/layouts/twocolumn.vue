              ...
              <SimpleBar class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                  <div class="collapse menu-dropdown" id="sidebarlanding">
                    <ul class="nav nav-sm flex-column">
                      <li class="nav-item">
                        <router-link to="/landing" target="_blank" class="nav-link"
                          data-key="t-one-page">{{ $t("t-one-page") }}</router-link>
                      </li>

                      <li class="nav-item">
                        <router-link to="/nft-landing" target="_blank" class="nav-link"
                          data-key="t-nft-landing">{{ $t("t-nft-landing") }}</router-link>
                      </li>

                      <li class="nav-item">
                        <router-link to="/job-landing" target="_blank" class="nav-link"
                          data-key="t-nft-landing">{{ $t("t-job") }}</router-link>
                      </li>
                    ...
                    <b-row>
                      ...
                      <b-col lg="4">
                        <ul class="nav nav-sm flex-column">
                          ...
                          <li class="nav-item">
                            <router-link to="/ui/general" class="nav-link" data-key="t-general">{{ $t("t-general") }}</router-link>
                          </li>
                          <li class="nav-item">
                      ...
                      <li class="nav-item">
                        ...
                        <div class="collapse menu-dropdown" id="sidebarApexcharts">
                          <ul class="nav nav-sm flex-column">
                            ...
                            <li class="nav-item">
                              <router-link to="/charts/apex-mixed" class="nav-link" data-key="t-mixed">{{ $t("t-mixed") }}</router-link>
                            </li>
                            <li class="nav-item">
