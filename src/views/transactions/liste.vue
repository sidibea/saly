...
export default{
    ...
    data(){
        return{
            ...
            colonnes : [
                ...
                { text: 'Numéro Klispay',  name: 'trans.montant' },
                { text: 'Numéro Klispay',  name: 'mp.nom' },
    ...
    methods:{
        ...
        refresh(){
            ...
            index = this.fields.findIndex((obj) => obj.colonne === 'trans.createdAt');
            if (index !== -1) {
                this.fields.splice(index, 1);
            }

            this.fields.push({colonne: 'trans.createdAt', operator: 'dateBetween', x: this.from, y: this.to, connector: 'and'})
                        ...
                        <div class="table-responsive">
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tr class="text-center text-white">
                                    ...
                                    <th class="bg-success" scope="col" colspan="5">Equipement</th>
                                ...
                                <tr>
                                    ...
                                    <th style="cursor: pointer">Equipement</th>
